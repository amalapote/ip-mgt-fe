        ...
        <div class="max-w-md w-full bg-white p-8 rounded-lg shadow-md">
            ...
            <div v-if="getIsError"  role="alert">
                <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:text-red-400" role="alert">
                    ...
                    <div>
                        <span v-if="getError" class="font-medium">{{ getError.message }}</span>
                        <ul v-if="getError.errors" class="mt-1.5 list-disc list-inside">
            ...
            <div v-if="getIsSuccess"  role="alert">
                <div class="flex p-4 mb-4 text-sm text-green-400 rounded-lg bg-green-400:10 dark:text-green-400" role="alert">
                    ...
                    <div>
                        <span class="font-medium">{{ 'Login successful! You will be redirected to homepage shortly.' }}</span>
                    </div>
                </div>
            </div>
 ...
 * @type {Ref<UnwrapRef<boolean>>}
 */
const action = store.auth;

const showAlert = ref(false)
const alertMessage = ref('This is a danger alert message!')
const email = ref('')
const password = ref('')
